      ...
      <header className="site-header" role="banner">
        <div className="header-inner">
          <a
            href="#hero"
            className="logo-link"
            aria-label="Don Dental Clinic — Home"
            onClick={(e) => {
              e.preventDefault();
              onNavigate('hero');
            }}
          >
            <img src="/assets/logo.svg" alt="Don Dental Clinic logo" width="160" height="40" />
          </a>

          <nav className="main-nav" aria-label="Main navigation">
            <a href="#hero" onClick={(e) => { e.preventDefault(); onNavigate('hero'); }}>{t('nav_home')}</a>
            <a href="#about" onClick={(e) => { e.preventDefault(); onNavigate('about'); }}>{t('nav_about')}</a>
            <a href="#services" onClick={(e) => { e.preventDefault(); onNavigate('services'); }}>{t('nav_services')}</a>
            <a href="#reviews" onClick={(e) => { e.preventDefault(); onNavigate('reviews'); }}>{t('proof_heading')}</a>
          ...
          <div className="header-actions">
            ...
            <button
              className="btn-pill-filled header-cta-btn"
